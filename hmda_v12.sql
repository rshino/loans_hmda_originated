...
select
	...
	/*_BYCT_ ,census_tract _BYCT_*/
 	/*_BYST_ ,GF(state_code) as state_code _BYST_*/
#	ifdef ROLL
...
#	endif ROLL
#	endif BYSELL
	/*_BY2HOM_ ,GF(occupancy_type) as occupancy_type _BY2HOM_*/
	, FC(count(*)) as Loans
...
--    GROUP by ONLY ONE
      ...
      /*_BYST_ state_code _BYST_*/
--    level 2 group
      /*_BY2HOM_ ,occupancy_type _BY2HOM_*/
--    COUNT cutoffs
