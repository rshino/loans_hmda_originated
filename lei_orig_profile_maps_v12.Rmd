...
leilist<-list()
leilist$IMB<-c('549300HTMO7FGRKRLV06') # CLIFFCO, INC., UNIONDALE, US-NY
leilist$dep<-c('549300EZG6KIP4HOUR65') # Adirondack Bank, Utica, US-NY


for(origtype in c('IMB','Deppositories'))
...
{
  print(overwrite)
#  ../00util/run_sql_v24.sh hmda_v016.sql F_LEI='549300HTMO7FGRKRLV06' F_YEAR=2022 F_TERM=360 BY_CT D_HGOAL D_ST
param<-paste0('F_LEI=',lei,' CONF CONV YEARS=',year,' BY_CT D_HGOAL D_ST')
  print(param)
